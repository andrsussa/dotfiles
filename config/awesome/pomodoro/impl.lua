...
return function(wibox, awful, naughty, beautiful, timer, awesome)
    ...
    pomodoro.short_pause_duration = 10 * 60
    pomodoro.long_pause_duration = 15 * 60
    pomodoro.work_duration = 50 * 60
    ...
    function pomodoro:ticking_time()
		...
		os.execute("sh -c 'play /home/andres/sounds/198841__bone666138__analog-alarm-clock.wav' &")
		...
		os.execute("sh -c 'play /home/andres/sounds/231277__steel2008__race-start-ready-go.wav' &")
