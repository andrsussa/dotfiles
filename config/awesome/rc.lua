...
tempwidget = lain.widgets.temp({
    settings = function()
        widget:set_markup(markup(gray, " Temp ") .. coretemp_now .. "°C ")
    end
})
...
netwidget = lain.widgets.net({
	...
	netupinfo:set_markup(markup(gray, " Up ") .. net_now.sent .. " ")
        netdowninfo:set_markup(markup(gray, " Down ") .. net_now.received .. " ")
    end
})
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "i", function () awful.util.spawn(keepass) end),
