...
run_once("nm-applet")
run_once("rescuetime")
run_once("redshift -l 4.6:-74.07 -m randr")
...
local task_manager = "lxtask"
local keepass      = "keepass2"
local pdfviewer    = "evince"
local musicplayer  = "spotify"
local syscalculator= "speedcrunch"
local syslocker    = "slock"
local filemngr     = "thunar"
local scroter      = "xfce4-screenshooter"
